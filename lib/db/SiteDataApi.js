...
export async function fetchGlobalAllData({
  ...
  // Guard against stale cache entries written before `notice` existed on the data
  // shape (missing key -> undefined, not null) — Next.js static export rejects
  // `undefined` in getStaticProps output, which is what broke every page's build.
